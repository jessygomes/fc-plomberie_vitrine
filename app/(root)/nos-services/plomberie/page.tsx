...
export default function ServicePlomberiePage() {
  ...
  return (
    <>
      {/* Données structurées JSON-LD pour le service plomberie */}
      <Script
        id="schema-plumbing-service"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://artisanat-fcplomberie.fr/nos-services/plomberie",
            name: "FC Plomberie - Chauffage - Sanitaire | Services de Plomberie",
            description:
              "Plombier professionnel en région Centre et Île-de-France. Réparation fuites d'eau, débouchage, installation chauffe-eau. Intervention 24h/24.",
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    ...
                    description:
                      "Détection précise et réparation durable de toutes fuites d'eau : robinets, canalisations, joints défaillants",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Remplacement de robinetterie et joints",
                    description:
                      "Installation et remplacement de robinetterie moderne, éviers, lavabos et tous équipements sanitaires",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description:
                      "Débouchage professionnel de canalisations bouchées : évier, lavabo, WC, évacuations",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Installation de chauffe-eau, ballons d'eau chaude et adoucisseurs",
                    description:
                      "Installation complète et entretien de chauffe-eau électriques, gaz, ballons d'eau chaude",
                  },
                },
              ],
            },
          ...
          <div className="relative z-10 py-10 px-6 text-center">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-white text-lg md:text-base font-two leading-relaxed tracking-wide">
                ...
                installation, réparation et maintenance de systèmes de
                plomberie, nous intervenons 24h/24 pour les urgences plomberie.
                Artisan plombier qualifié, nous garantissons des interventions
                soignées, durables et aux normes pour particuliers et
                professionnels.
              </p>
            </div>
          </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="bg-white/50 rounded-lg p-4 mt-4">
                    ...
                    <p className="font-two text-primary-500 text-sm font-medium">
                      Besoin d'un plombier en urgence ? Contactez-nous — nous
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-md p-6 shadow-lg">
                ...
                <p className="font-two text-noir-500">
                  Le tarif dépend du type d'intervention. Nous proposons un
                  devis gratuit et sans engagement. Nos tarifs sont transparents
                  et compétitifs en région Centre et Île-de-France.
                </p>
              </div>
              <div className="bg-white rounded-md p-6 shadow-lg">
                <h4 className="font-one text-xl font-bold text-noir-700 mb-3">
                ...
                <p className="font-two text-noir-500">
                  Oui, nous intervenons 24h/24 et 7j/7 pour les urgences
                  plomberie : fuites d'eau, canalisations bouchées, pannes de
                  chauffe-eau dans toute la région.
                </p>
              </div>
            </div>
          </div>
