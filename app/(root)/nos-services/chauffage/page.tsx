...
export default function ServiceChauffagePage() {
  ...
  return (
    <>
      {/* Données structurées JSON-LD pour le service chauffage */}
      <Script
        id="schema-heating-service"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "@id": "https://artisanat-fcplomberie.fr/nos-services/chauffage",
            name: "FC Plomberie - Chauffage - Sanitaire | Services de Chauffage",
            description:
              "Chauffagiste professionnel en région Centre et Île-de-France. Installation chaudière, entretien.",
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    "@type": "Service",
                    name: "Installation de chaudières gaz et électriques",
                    description:
                      "Installation complète de chaudières haute performance, gaz naturel, propane ou électriques",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Entretien et maintenance de systèmes de chauffage",
                    description:
                      "Entretien annuel obligatoire, nettoyage, réglage et optimisation de vos équipements",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Installation de radiateurs et planchers chauffants",
                    description:
                      "Pose de radiateurs haute efficacité, installation de planchers chauffants hydrauliques",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    "@type": "Service",
                    name: "Dépannage et réparation d'urgence",
                    description:
                      "Intervention rapide 24h/24 pour panne de chauffage, chaudière en panne",
                  },
                },
              ],
            },
          ...
          <div className="relative z-10 py-10 px-6 text-center">
            <div className="max-w-5xl mx-auto">
              ...
              <h3 className="font-one text-2xl md:text-3xl font-bold text-white mb-6">
                Votre Chauffagiste de Confiance en Région Centre et
                Île-de-France
              </h3>
              <p className="text-white text-lg md:text-base font-two leading-relaxed tracking-wide">
                Depuis 2024, FC Plomberie est votre chauffagiste de référence
                dans toute la région Centre-Val de Loire (Orléans, Tours, Blois,
                Chartres, Bourges, Châteauroux...) et en Île-de-France.
                Spécialisés en installation, entretien et dépannage de systèmes
                de chauffage, nous intervenons 24h/24 pour les urgences
                chauffage. Artisan chauffagiste qualifié, nous garantissons des
                installations performantes, un entretien certifié et des
                dépannages rapides pour particuliers et professionnels.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-linear-to-br from-second-100 to-primary-100 rounded-md p-8 border border-second-200/50">
                ...
                <div className="text-center space-y-4">
                  <p className="font-two text-noir-700">
                    Chaudière en panne, radiateurs froids, problème de
                    régulation ?
                  </p>
                  ...
                  <div className="bg-white/50 rounded-lg p-4 mt-4">
                    ...
                    <p className="font-two text-second-500 text-sm font-medium">
                      Besoin d'un chauffagiste en urgence ? Contactez-nous —
                      nous vous rappelons même si vous laissez un message sur le
                      répondeur.
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-lg">
                ...
                <p className="font-two text-noir-500">
                  ...
                  intervenons rapidement en région Centre et Île-de-France avec
